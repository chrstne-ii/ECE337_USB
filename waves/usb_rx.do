...
add wave -noupdate -group ByteShifter /tb_usb_rx/DUT/byteShifter/shift_enable
add wave -noupdate -group ByteShifter /tb_usb_rx/DUT/byteShifter/serial_in
add wave -noupdate -group ByteShifter /tb_usb_rx/DUT/byteShifter/parallel_out
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {2214012 ps} 0}
...
update
WaveRestoreZoom {0 ps} {10369580 ps}

...
add wave -noupdate -group RCU -radix binary /tb_usb_rx/DUT/pbits
add wave -noupdate -group RCU -radix binary /tb_usb_rx/DUT/mbits
add wave -noupdate -group RCU /tb_usb_rx/DUT/rcu/new_packet
add wave -noupdate -group RCU /tb_usb_rx/DUT/rcu/byte_in
add wave -noupdate -group RCU /tb_usb_rx/DUT/rcu/byte_shift
add wave -noupdate -group RCU /tb_usb_rx/DUT/rcu/bits_shift
add wave -noupdate -group RCU /tb_usb_rx/DUT/byte_done
add wave -noupdate -group RCU /tb_usb_rx/DUT/bits_done
add wave -noupdate -group RCU /tb_usb_rx/DUT/rcu/saved_pid
add wave -noupdate -group RCU /tb_usb_rx/DUT/rcu/saved_byte1
add wave -noupdate -group RCU /tb_usb_rx/DUT/rcu/saved_byte2
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {2935000 ps} 0}
...
update
WaveRestoreZoom {8607927 ps} {9898657 ps}
